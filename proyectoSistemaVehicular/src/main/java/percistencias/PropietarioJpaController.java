...
import percistencias.exceptions.NonexistentEntityException;
...
public class PropietarioJpaController implements Serializable {
    ...
    public PropietarioJpaController() {
        this.emf = Persistence.createEntityManagerFactory("com.mycompany_proyectoSistemaVehicular_jar_1.0-SNAPSHOTPU");
